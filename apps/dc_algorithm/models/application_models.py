...
from utils.data_cube_utilities.sdc_utilities import create_scl_clean_mask # Modified by CERTH 
...
class Satellite(models.Model):
    ...
    def get_clean_mask_func(self):
        ...
        options = {
            ...
            'scl_mask': lambda ds: create_scl_clean_mask(ds.scl, [4, 5, 6, 7, 11]), #Modified by CERTH
        ...
        key = 'bit_mask' if 'pixel_qa' in self.get_measurements() else \
              ...
              'scl_mask' if 'scl' in self.get_measurements() else \
              'default'
